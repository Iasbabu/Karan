...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="http://t.me/Karan_ContactBot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+RJdOYPYMYtE3M2Rl"),
            InlineKeyboardButton(text="🛠️ Repo", url="http://t.me/Karan_ContactBot"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [{CREDIT}](http://t.me/Karan_ContactBot)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
